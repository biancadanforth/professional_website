        ...
        <section className="primary">
          <div className="welcome-wrapper">
            <div className="welcome-profile-wrapper">
              <img className="welcome-profile" src="images/biancaWeld.jpg" alt="Bianca Danforth" />
            </div>
        ...
        <section className="secondary">
          ...
          <div className="work-wrapper">
            <div className="project">
              ...
              <a className="project-thumbnail" href="/work/to-do-list">
                <img src="images/to-do-list-cropped.png" alt="To Do List application" />
              </a>
            </div>
            <div className="project">
              <h4>2016 | Self-Initiated</h4>
              ...
              <a className="project-thumbnail" href="#e-mail-sign-up">
              <img src="images/e-mail-sign-up-cropped.jpg" alt="E-mail Sign Up Page" />
              </a>
            </div>
            <div className="project">
              ...
              <a className="project-thumbnail" href="#ferrofluid-pool">
              <img src="images/ferrofluid-pool-cropped.jpg" alt="Ferrofluid Pool science exhibit" />
              </a>
            </div>
            <div className="project">
              <h4>2012 | Stanford</h4>
              ...
              <a className="project-thumbnail" href="#chair">
                <img src="images/chair-cropped.jpg" alt="Chair" />
              </a>
            </div>
          </div>
        </section>
