        ...
        <section className="primary">
          <div className="contact-body">
            ...
            <div className = "form-wrapper">
              <form action="https://formspree.io/biancadanforth@gmail.com" method="post">
                <label>Name
                  <input type="text" name="Name" placeholder="Joe Schmoe" required />
                </label>
                <label>E-mail
                  <input id="e-mail" type="Email" name="E-mail" placeholder="joeschmoe@example.com" required />
                </label>
                <p className="note">You will receive a copy of your message at this e-mail address.</p>
                <label className="textarea-label">Message
                  <textarea name="Message" placeholder="I'd like to hire you." required></textarea>
                </label>
                ...
                <input type="hidden" name="_subject" value="Message through biancadanforth.com" />
                ...
                <input id="carbon-copy" type="hidden" name="_cc" value="" />
