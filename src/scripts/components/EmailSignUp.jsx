...
const codePenEmbed = "<iframe class='project-thumbnail' height='400' scrolling='no' title='Fluid Grid' src='//codepen.io/biancadanforth/embed/wWLGRK/?height=400&theme-id=light&default-tab=result&embed-version=2' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>See the Pen <a href='http://codepen.io/biancadanforth/pen/wWLGRK/'>Fluid Grid</a> by biancadanforth (<a href='http://codepen.io/biancadanforth'>@biancadanforth</a>) on <a href='http://codepen.io'>CodePen</a>.</iframe>";
        ...
        <section className="secondary">
          ...
          <div className="work-wrapper">
            ...
            <div className="project">
              ...
              <p>
                I made one of my first codepens on this project, modifying some code I found to make a fluid grid in CSS. I used these styles on the final page.
              </p>
            </div>
            <div className="project">
              <h2>Development</h2>
